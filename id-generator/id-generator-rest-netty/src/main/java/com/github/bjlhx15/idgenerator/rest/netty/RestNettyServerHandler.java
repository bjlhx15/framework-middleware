...
@Sharable
public class RestNettyServerHandler extends ChannelHandlerAdapter {
    ...
    private static final Log log = LogFactory
            .getLog(RestNettyServerHandler.class);

    private IdService idService;

    public RestNettyServerHandler() {
        ApplicationContext ac = new ClassPathXmlApplicationContext(
                "spring/idgenerator-rest-main.xml");
